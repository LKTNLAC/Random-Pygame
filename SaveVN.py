...
pygame.display.set_caption('Kill 3 que')

# images and sounds
bg_img = pygame.image.load('Media/palace.jpg')
bg_img = pygame.transform.scale(bg_img, (600, 600))
target_img = pygame.image.load('Media/3stick.png')
crosshair_img = pygame.image.load('Media/crosshair.png')
